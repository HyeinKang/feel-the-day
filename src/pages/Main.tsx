...
import { useCoordinates } from "@/contexts/Coordinates/useCoordinates";
    ...
    <>
      <div className="flex flex-col h-dvh">
        <main className="relative flex-grow">
          <Map />
          <div className="absolute top-0 sm:top-4 right-0 sm:right-4 z-20 w-full sm:max-w-[480px] max-h-[100dvh] sm:max-h-[90dvh] flex flex-col bg-[#eaeaea80] dark:bg-[#40404080] backdrop-blur-[24px] p-4 sm:p-6 sm:rounded-xl">
