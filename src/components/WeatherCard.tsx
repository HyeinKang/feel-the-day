        ...
        <section className="mt-8">
          <div className="flex justify-center items-center gap-x-4 mt-4">
            <div className="flex w-full justify-center items-center">
                <img src={SunnyCloudyIcon} alt="Sunny cloudy" className="w-20 h-20" />
            </div>
        ...
        <section className="mt-8">
          <div className="flex justify-between mt-8">
              <div className="flex flex-col gap-y-2 items-center w-1/3">
                  ...
                  <div className="flex w-full justify-center items-center">
                      <img src={SunnyCloudyIcon} alt="Sunny cloudy" className="w-12 h-12" />
                  </div>
          ...
          <div className="flex flex-start gap-x-6 py-2 overflow-x-auto">
            <div className="flex flex-col items-center gap-y-6">
                <h4 className="whitespace-nowrap text-sm">Now</h4>
                  <div className="flex w-full justify-center items-center">
                      <img src={SunnyCloudyIcon} alt="Sunny cloudy" className="w-8 h-8" />
                  </div>
